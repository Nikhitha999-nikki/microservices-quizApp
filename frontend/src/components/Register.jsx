...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (status === 409) showToast('Username already exists. Try another!')
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .register-card { animation: slideIn 0.6s ease forwards; }
        .submit-btn-reg:hover {
          transform: translateY(-2px);
          box-shadow: 0 8px 25px rgba(99,102,241,0.5) !important;
        }
        .input-field-reg:focus {
      ...
      <div className="register-card" style={{
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading} className="submit-btn-reg"
            style={{
