...
<h3 align="center">Welcome to the microservices-quizApp project! 😍<br>
We appreciate your interest in contributing.😊<br> </h3>

First off, thank you for considering contributing to **microservices-quizApp!** We're excited to have you join our community. Every contribution, no matter how small, helps us build the best academic resource platform for students.
...
* ⌛ Reviews may take **24–72 hours** depending on activity. Thanks for your patience!
 ...
 > For Any Query, Send DM on LinkedIn [Nikhitha Malapula](https://www.linkedin.com/in/malapula-nikhitha-b809592aa).
...
- Take a look at the existing [Issues](https://github.com/Nikhitha999-nikki/microservices-quizApp/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/Nikhitha999-nikki/microservices-quizApp/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
...
This **CONTRIBUTING.md** was prepared with **❤️** by **Divya Jain** for **microservices-quizApp** as part of the **NSoC'26 program.**
...
<h3 align="center">
Thank you for contributing to microservices-quizApp 🌟
<br>
