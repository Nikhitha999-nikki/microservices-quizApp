# Contributor Covenant Code of Conduct — microservices-quizApp NSoC'26
...
This Code of Conduct is adapted from the [Contributor Covenant (v3.0)](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), with modifications tailored for **microservices-quizApp under the Nexus Spring of Code (NSoC’26)**.  
...
We thank every contributor, maintainer, and member for **making microservices-quizApp a safe, inclusive, and inspiring space.** ✨💡  
...
Let’s make **microservices-quizApp** a place where everyone feels welcome to **learn, contribute, and innovate.** 🍰🤖💡 
